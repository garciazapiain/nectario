    ...
    return (
        <main id="sobrenosotros" className=''>
            <div className='md:hidden'>
                ...
                <div className='flex self-center items-center justify-center justify-items-center m-4'>
            ...
            <div className='hidden md:flex flex-col'>
                ...
                <div className='flex self-center items-center justify-center justify-items-center m-5'>
